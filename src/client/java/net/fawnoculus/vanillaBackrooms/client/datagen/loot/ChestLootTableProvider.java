	...
	public void accept(BiConsumer<RegistryKey<LootTable>, LootTable.Builder> lootTable) {
		...
		lootTable.accept(ModLootTables.LEVEL_0_COMMON, LootTable.builder()
		  .pool(LootPool.builder()
			.rolls(UniformLootNumberProvider.create(3f, 0f))
			.with(ItemEntry.builder(Items.COBWEB))
		  )
		  .pool(LootPool.builder()
			.rolls(UniformLootNumberProvider.create(1f, 0f))
		...
		lootTable.accept(ModLootTables.LEVEL_0_UNCOMMON, LootTable.builder()
		  .pool(LootPool.builder()
			.rolls(UniformLootNumberProvider.create(2f, 0f))
			.with(ItemEntry.builder(Items.COBWEB))
		  )
		  .pool(LootPool.builder()
			.rolls(UniformLootNumberProvider.create(3f, 0f))
		  ...
		  .pool(LootPool.builder()
			...
			.with(ItemEntry.builder(Items.POISONOUS_POTATO))
			.with(ItemEntry.builder(Items.BAKED_POTATO)
			  .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(7f, 1f)))
			)
		  )
		  .pool(LootPool.builder()
			.rolls(UniformLootNumberProvider.create(1f, 0f))
		...
		lootTable.accept(ModLootTables.LEVEL_0_RARE, LootTable.builder()
		  ...
		  .pool(LootPool.builder()
			.rolls(UniformLootNumberProvider.create(4f, 0f))
			.with(ItemEntry.builder(ModItems.ALMOND_WATTER))
		  )
		  .pool(LootPool.builder()
			.rolls(UniformLootNumberProvider.create(3f, 0f))
			.with(ItemEntry.builder(Items.BAKED_POTATO)
			  .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(5f, 1f)))
			)
			.with(ItemEntry.builder(Items.COOKED_CHICKEN)
			  .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(3f, 1f)))
			)
		  )
		  .pool(LootPool.builder()
			.rolls(UniformLootNumberProvider.create(2f, 0f))
			...
			.with(ItemEntry.builder(Items.DIAMOND_SWORD)
			  .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(1f, 0f)))
			)
		...
		lootTable.accept(ModLootTables.LEVEL_0_EPIC, LootTable.builder()
		  .pool(LootPool.builder()
			.rolls(UniformLootNumberProvider.create(2f, 0f))
			.with(ItemEntry.builder(ModItems.ALMOND_WATTER)
			  .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(4f, 2f)))
			)
		  )
		  .pool(LootPool.builder()
			.rolls(UniformLootNumberProvider.create(1f, 0f))
			.with(ItemEntry.builder(Items.BAKED_POTATO)
			  .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(14, 1f)))
			)
			.with(ItemEntry.builder(Items.COOKED_CHICKEN)
			  .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(6f, 1f)))
			)
		...
		lootTable.accept(ModLootTables.LEVEL_1_COMMON, LootTable.builder()
		  .pool(LootPool.builder()
			.rolls(UniformLootNumberProvider.create(5f, 0f))
			.with(ItemEntry.builder(ModItems.ALMOND_WATTER))
		  )
		  .pool(LootPool.builder()
			.rolls(ConstantLootNumberProvider.create(3f))
			.with(ItemEntry.builder(Items.COOKED_BEEF)
			  .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(8f, 0f)))
			)
		  )
		  .pool(LootPool.builder()
			.rolls(ConstantLootNumberProvider.create(1f))
			...
			.with(ItemEntry.builder(Items.WIND_CHARGE)
			  .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(24f, 1f)))
			)
		  )
		  .pool(LootPool.builder()
			.rolls(UniformLootNumberProvider.create(2f, 0f))
		...
		lootTable.accept(ModLootTables.LEVEL_1_RARE, LootTable.builder()
		  .pool(LootPool.builder()
			.rolls(UniformLootNumberProvider.create(2f, 1f))
			.with(ItemEntry.builder(ModItems.ALMOND_WATTER)
			  .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(13f, 1f)))
			)
		  ...
		  .pool(LootPool.builder()
			...
			.with(ItemEntry.builder(Items.GOLDEN_CARROT)
			  .apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(8f, 1f)))
			)
