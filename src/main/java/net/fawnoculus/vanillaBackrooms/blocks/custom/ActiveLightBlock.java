...
public class ActiveLightBlock extends BlockWithEntity implements PolymerBlock {
	public static final MapCodec<ActiveLightBlock> CODEC = createCodec(ActiveLightBlock::new);
