...
import net.fawnoculus.vanilla_backrooms.levels.ClipChanceContainer;
import net.fawnoculus.vanilla_backrooms.misc.tags.ModItemTags;
import net.fawnoculus.vanilla_backrooms.util.config.ConfigFile;
import net.fawnoculus.vanilla_backrooms.util.config.ConfigOption;
import net.fawnoculus.vanilla_backrooms.util.config.encoder.JsonConfigEncoder;
...
public class VanillaBackroomsConfig {
    ...
    public static final ConfigOption<Boolean> SUFFOCATION_NOCLIP_ONLY_PLAYERS = FILE.newOption(
      "suffocation_noclip_players",
      Codec.BOOL,
      true,
      "Whether Only players will be able to noclip by suffocating [default: true]"
    );
    ...
    public static final ConfigOption<Boolean> DEATH_NOCLIP_ONLY_PLAYERS = FILE.newOption(
      "death_noclip_only_players",
      Codec.BOOL,
      true,
      "Whether Only players will be able to noclip by dying [default: true]"
    );
    ...
    public static final ConfigOption<Component> DISABLE_COMMANDS_MESSAGE = FILE.newOption(
      "disable_chat_message",
      ComponentSerialization.CODEC,
      Component.literal("The Chat is disabled in the Backrooms").withStyle(ChatFormatting.RED),
    ...
    public static final ConfigOption<Component> DISABLE_CHAT_MESSAGE = FILE.newOption(
      "disable_chat_message",
      ComponentSerialization.CODEC,
      Component.literal("The Chat is disabled in the Backrooms").withStyle(ChatFormatting.RED),
    ...
    public enum HardCoreOption implements StringRepresentable {
        NEVER("never"),
        HARDCORE_ONLY("hardcore_only"),
        NON_HARDCORE_ONLY("non_hardcore_only"),
        ALWAYS("always");

        public static final Codec<HardCoreOption> CODEC = StringRepresentable.fromEnum(HardCoreOption::values);
