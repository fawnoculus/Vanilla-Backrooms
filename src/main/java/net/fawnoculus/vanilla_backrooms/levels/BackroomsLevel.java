...
import net.fawnoculus.vanilla_backrooms.levels.generators.MultiBackroomsGenerator;
import net.fawnoculus.vanilla_backrooms.levels.generators.RingBackroomsGenerator;
import net.fawnoculus.vanilla_backrooms.levels.generators.SimpleBackroomsGenerator;
...
public record BackroomsLevel(int number, String name, Vec3 spawnPos, BackroomsGenerator generator) {
    ...
    public static void initialize() {
        ...
        builder(1)
          ...
          .setSpawnBlock(new Vec3(28.5, 14, 23.5))
        ...
        builder(2)
          ...
          .setSpawnBlock(new Vec3(17.5, 2, 26.5))
        ...
        builder(4)
          ...
          .setSpawnBlock(new Vec3(30, 1, 11))
          .setGenerator(RingBackroomsGenerator.builder(true)
    ...
    public static class Builder {
        ...
        private Vec3 spawnBlock = new Vec3(BackroomsGenerator.HORIZONTAL_OFFSET / 2.0, 2.0, BackroomsGenerator.HORIZONTAL_OFFSET / 2.0);
        ...
        public Builder setSpawnBlock(Vec3 spawnBlock) {
